...
void movePacman(void* arg)
{
    ...
    while (true)
    {
        prevDirectionX = pacman_direction_x;
        prevDirectionY = pacman_direction_y;
        ...
        {
            // If the next position is a wall, do not move
            pacman_direction_x = prevDirectionX;
            pacman_direction_y = prevDirectionY;
